...
$(function () {
    ...
    var mapOptions = {
        center: new google.maps.LatLng(31.45, -99.18),
        zoom: 6,
    ...
    $.ajax({
        ...
        success: function (d) {
			...
			do{
				...
				numberOfDaysBack++;
			} while(!UrlExists("data/" + today + ".json?_=" + new Date().getTime()) && numberOfDaysBack < 1);
...
function loadList() {
    setTimeout(function () {
        ...
        //$("#mapoverlay").html(dnsCheckInfoString); // mapoverlay är bortkommenterad. Ger annars en vit box med lite text om utfall i detalj.
