<?php
	...
	*/
	...
	$resultatPath = "dns/" . $datum . ".txt";	//  serversoekvaeg: /home/kommunermeddnssec/resultat

	// Haer finns output fraan dnscheck
	$errorPath = "dns/" . $datum . "/"; 			// konkatenera med host. Innehaaller ERROR och WARNINGs samt INFO.. maska ut raett..


	// finns hostnamnet i denna fil saa har den ipv6 paa dns
	$ipDns6Path = "ipv6/" . $datum . "/dns6"; 		// 	/kipv6/script/history/[datum]/dns6 = textfil med domaener som har v6

	// finns hostnamnet i denna fil saa har den ipv6 paa mx
	$ipMx6Path = "ipv6/" . $datum . "/mx6"; 		// 	/kipv6/script/history/[datum]/mx6 = textfil med domaener som har v6

	// finns hostnamnet i denna fil saa har den ipv6 paa www
	$ipWww6Path = "ipv6/" . $datum . "/www6"; 		// 	/kipv6/script/history/[datum]/www6 = textfil med domaener som har v6
	...
	*/
	...
	function createOutput($dateOfIntrest){
		...
		$csv =  file_get_contents("public_html/texas_countyhosts.csv");
		$rows = str_getcsv( $csv, "\n");
		$lastRow = count($rows);
