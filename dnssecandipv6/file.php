...
<tr><td style="background-color:#FF0000;height:20px"><img src="tick.png"/>&nbsp;domain</td><td>Signed with DNSSEC but with error</td></tr>
			...
			<div class="subContainer">
				...
				<?php
					...
					echo `cat resultat.txt | grep \.se|cut -d , -f 2|grep yes|wc -l` . " av " . `cat resultat.txt | grep \.se|wc -l` . " .se domains signed<br/>\n\n";
					//echo $okDomCount . " av " . ($okDomCount + $notOkDomCount) . " domains signed<br/>\n\n";
