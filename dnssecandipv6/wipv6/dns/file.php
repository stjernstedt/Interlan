...
<html>
	...
	<body>
		<div class="mainContainer" style="padding:20px;border:1px solid #e0e0e0;position:absolute;left:50%;width:800px;margin-left:-400px;margin-top:50px">
			...
			Domain's participating in World IPv6 day 2011 tested with .SE's <a href=http://dnscheck.iis.se>http://dnscheck.iis.se</a>
                        </div>
        ...
        <tr>
			...
			<div>
				...
				<table cellspacing="3" cellpadding="2" style="margin-bottom:7px;border:1px solid black;font: 11px verdana">
					...
					<tr><td style="background-color:#FF0000;height:20px"><img src="tick.png"/>&nbsp;domain</td><td>Signed with DNSSEC but with errors</td></tr>
