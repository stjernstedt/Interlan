...
<html>
	<head>
		...
		<title>Myndigheter med DNSSEC</title>
	...
	<body>
		<div class="mainContainer" style="padding:20px;border:1px solid #e0e0e0;position:absolute;left:50%;width:800px;margin-left:-400px;margin-top:50px">
			<h1>Myndigheter med DNSSEC</h1>
			<div class="subContainer">
				<p><b>myndighetermeddnssec.se</b> är en fristående hemsida som listar alla myndighetsdomäners hälsa och visar om de är signerade med <b><a href=http://en.wikipedia.org/wiki/DNSSEC>DNSSEC</a> </b>eller inte. Kontakta mig om någon domän fattas eller ska tas bort.<br>
<?php echo `./dnscheck`; ?>
