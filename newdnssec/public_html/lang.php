...
*/
	...
	$langText = array(
		...
		"DOMAINS_WITHOUT_ERROR" => array("Korrekt <div style=\"display:inline;width:16px;height;16px,overflow:hidden;background-color:#eaea6a;border:1px solid black;\">&nbsp;&nbsp;&nbsp;</div> = Osignerade", "Without error <div style=\"display:inline;width:16px;height;16px,overflow:hidden;background-color:#eaea6a;border:1px solid black;\">&nbsp;&nbsp;&nbsp;</div> = Unsigned"),
		...
		"IPV6_ALL" => array("IPv6 p&aring; WWW, DNS och Mail<br><br><font color=green><b>Gr&oumln</b></font> - IPv6 p&aring WWW, DNS och mail<br><font color=orange><b>Orange</b></font> - IPv6 p&aring n&aringgon av WWW, DNS och mail<br><font color=red><b>R&oumld</b></font> - Ingen IPv6 alls<br><br>Sidan uppdatera en g&aringng per natt<br>Ni kan se historik med pilarna och datum nedan.", "IPv6 on WWW, DNS and Mail<br><br><font color=green><b>Green</b></font> - IPv6 on WWW, DNS and mail<br><font color=orange><b>Orange</b></font> - IPv6 on any of WWW, DNS or mail<br><font color=red><b>Red</b></font> No IPv6"),
		...
		"DNSCHECK_LINK" => array("<a href=\"http://dnscheck.iis.se\" target=\"_blank\">DNSCheck</a> kontrollerar dom&auml;nens status och vad betyder <a href=\"http://dnscheck.iis.se/?faq=1&test=standard#f7\" target=\"_blank\">fel respektive varning</a>? Klicka p&aring; respektive kommun f&ouml;r mer information.<br>Ni kan se historik med pilarna och datum nedan.<br/><br/><a href=\"http://kommunermeddnssec.se/dns\">Bes&ouml;k gamla sidan</a>","<a href=\"http://dnscheck.iis.se\" target=\"_blank\">DNSCheck</a> is is used to control the domain status. A detailed <a href=\"http://dnscheck.iis.se/?faq=1&test=standard#f7\" target=\"_blank\">status and explanation</a> are available by clicking on the map.<br/><br/><a href=\"http://kommunermeddnssec.se/dns\">Visit old site</a>"),
		
		"IPV6_OLDSITE" => array("<a href=\"http://kommunermeddnssec.se/ipv6/\">Bes&ouml;k gamla sidan</a>","<a href=\"http://kommunermeddnssec.se/ipv6/\">Visit old site</a>"),
		
		"PROJECT_FINANCIEER" => array("Detta projekt &auml;r finansierat av <a href=\"https://www.iis.se/internet-for-alla/internetfonden/om-internetfonden\" target=\"_blank\">Internetfonden</a>. Ni hittar fler projekt finansierade av dem <a href=\"https://www.iis.se/internet-for-alla/internetfonden/uppdrag\" target=\"_blank\">h&auml;r</a>", "This project was financed by <a href=\"https://www.iis.se/internet-for-alla/internetfonden/om-internetfonden\" target=\"_blank\">Internetfonden</a>. You will find more projects financed by Internetfonden <a href=\"https://www.iis.se/internet-for-alla/internetfonden/uppdrag\" target=\"_blank\">here</a>. Note: pages in swedish."),
		
		"SOURCE_LINK" => array("Ladda ned k&auml;llkod", "Download source")
