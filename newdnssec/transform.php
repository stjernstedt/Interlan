<?php
	...
	*/
	...
	$resultatPath = "data/resultat/" . $datum . ".txt";	//  serversoekvaeg: /home/kommunermeddnssec/resultat

	// Haer finns output fraan dnscheck
	$errorPath = "data/history/" . $datum . "/"; 			// konkatenera med host. Innehaaller ERROR och WARNINGs samt INFO.. maska ut raett..
