...
function removeEndingDot($str){
	...
	function getContent(){
		...
		while( !feof(STDIN) ){
			...
			if( sizeof($arrParts) > 3 ){
				// arvika.se,,yes,0,0,hostmaster.arvika.se.,ns2.arvika.se.,ns1.arvika.se.,dns5.telia.com.,
				$host = "";
				$yesOrEmpty = "";
				$recursive = "";
				$errorLevel = "";
				...
				$data = $data . outputSingleDomain($host, $yesOrEmpty != "", $email, $nsList, $errorLevel, $warningLevel, $recursive);
	...
	function outputSingleDomain($host, $isSecure, $email, $nsList, $errLevel, $warnLevel, $isRecursive){
	...
	<body>
		<div class="mainContainer" style="padding:20px;border:1px solid #e0e0e0;position:absolute;left:50%;width:800px;margin-left:-400px;margin-top:50px">
			...
			<div class="subContainer">
				<p><b>kommunermeddnssec.se</b> är en fristående hemsida som listar alla kommundomäners hälsa och visar om de är signerade med <b><a href=http://en.wikipedia.org/wiki/DNSSEC>DNSSEC</a> </b>eller inte.<br>
<?php echo `./dnscheck`; ?>
			...
			<div>
				...
				<table cellspacing="3" cellpadding="2" style="margin-bottom:7px;border:1px solid black;font: 11px verdana">
					<tr><td style="background-color:#A0FFA0;width:145px;height:20px"><img src="tick.png"/>&nbsp;domän</td><td>Signerad med DNSSEC och utan fel</td></tr>
					<tr><td style="background-color:#FFA500;height:20px"><img src="tick.png"/>&nbsp;domän</td><td>Signerad med DNSSEC men med varning</td></tr>
					<tr><td style="background-color:#FFA500;height:20px">domän</td><td>Varning i DNSCheck</td></tr>
					<tr><td style="background-color:#FF0000;height:20px">domän</td><td>Fel i DNSCheck</td></tr>
					<tr><td style="background-color:#FFFFFF;height:20px">domän</td><td>Utan anmärkning i DNSCheck men inte signerad</td></tr>
				</table>
