<?php
	...
	$langText = array(
		...
		"DNSCHECK_LINK" => array("<a href=\"http://dnscheck.iis.se\" target=\"_blank\">dnscheck</a> kontrollerar dom&auml;nens status och vad betyder <a href=\"http://dnscheck.iis.se/?faq=1&test=standard#f7\" target=\"_blank\">fel respektive varning</a>? Klicka p&aring; respektive kommun f&ouml;r mer information.<br/><br/><a href=\"../kdns/index.html\">Bes&ouml;k gamla sidan</a>","<a href=\"http://dnscheck.iis.se\" target=\"_blank\">dnscheck</a> is is used to control the domain status and what does <a href=\"http://dnscheck.iis.se/?faq=1&test=standard#f7\" target=\"_blank\">error and warnings mean</a>? Click on the appropriate municipality for more information.<br/><br/><a href=\"../kdns/index.html\">Visit old site</a>"),
